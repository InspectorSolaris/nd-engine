...
namespace nd::src::graphics::vulkan
{
    ...
    bool
    isInstanceLayersSupported(const vec<str>& layers) noexcept
    {
        ND_SET_SCOPE();
    ...
    bool
    isInstanceExtensionsSupported(const vec<str>& extensions) noexcept
    {
        ND_SET_SCOPE();
    ...
    Instance
    createInstance(opt<const InstanceCfg>::ref cfg) noexcept(ND_ASSERT_NOTHROW)
    {
        ND_SET_SCOPE();
        ...
        ND_ASSERT_EXEC(vkCreateInstance(&createInfo, ND_VULKAN_ALLOCATION_CALLBACKS, &instance) == VK_SUCCESS);
