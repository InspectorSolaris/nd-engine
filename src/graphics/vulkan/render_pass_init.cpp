...
namespace nd::src::graphics::vulkan
{
    ...
    RenderPass
    createRenderPass(opt<const RenderPassCfg>::ref cfg, const VkDevice device) noexcept(ND_VK_ASSERT_NOTHROW)
    {
        ND_SET_SCOPE();
        ...
        ND_VK_ASSERT(vkCreateRenderPass(device, &createInfo, ND_VK_ALLOCATION_CALLBACKS, &renderPass));
